...
class EditDistClassifier(object):
    '''
    TODO
    '''

    def __init__(self, editdist_threshold=0.7):
        '''
        Constructor
        '''

        self.t = editdist_threshold
    ...
    def predict(self, X, test_data, test_data_idx=None):
        ...
        '''
        scores = self.predict_proba(X, test_data, test_data_idx=None)
    ...
    def predict_proba(self, X, test_data, test_data_idx=None):
        ...
        '''
        idx = test_data.get_feat_idx("lev_simi")
        ret = np.column_stack(
